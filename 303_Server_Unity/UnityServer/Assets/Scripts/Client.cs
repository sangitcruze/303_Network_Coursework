...
public class Client
{
    ...
    public class TCP
    {
        ...
        /// <summary>Initializes the client's TCP info.</summary>
        ...
        /// <summary>Sends data to the client through TCP.</summary>
        ...
        private void ReceiveCallback(IAsyncResult _result)
        {
            try
            {
                //in order to receive any data we call the EndRead method which returns an int
                //representing the number of byte that we read from the stream 
                int _byteLength = stream.EndRead(_result);
                if (_byteLength <= 0)
                {
                    //if no data is received, we disconnect the client
